...
export const NODE_META: Record<string, NodeMeta> = {
  ...
  skill_hand:   { page: 'rin', col: 0, row: 2 },
  skill_breast: { page: 'rin', col: 0, row: 3 },
  skill_foot:   { page: 'rin', col: 0, row: 4 },
  skill_double: { page: 'rin', col: 0, row: 5 },
  skill_orgy:   { page: 'rin', col: 0, row: 6 },
  desire_train:  { page: 'rin', col: 2, row: 2 },
  desire_liquor: { page: 'rin', col: 2, row: 3 },
  m_cloth_outer: { page: 'rin', col: 3, row: 3 },
  m_cloth_shoes: { page: 'rin', col: 3, row: 4 },
  m_cloth_inner: { page: 'rin', col: 3, row: 5 },
  m_scent:       { page: 'rin', col: 3, row: 6 },
  // 势力经营:三条纵链(采购/威望/制度);制度的四个子节点在 rule_code 下扇形展开
  buy_drugstore:  { page: 'biz', col: 0, row: 0 },
  buy_wholesale:  { page: 'biz', col: 0, row: 1 },
  buy_convoy:     { page: 'biz', col: 0, row: 2 },
  ...
  // 道场:r0=独立多级根一排;下方三条纵链(体能/陪练/慰安)
  weapon:      { page: 'dojo', col: 0, row: 0 },
  martial:     { page: 'dojo', col: 1, row: 0 },
  stamina:     { page: 'dojo', col: 2, row: 0 },
  physique:    { page: 'dojo', col: 3, row: 0 },
  gear:        { page: 'dojo', col: 4, row: 0 },
  phys_train:  { page: 'dojo', col: 0, row: 1 },
  phys_train2: { page: 'dojo', col: 0, row: 2 },
  phys_train3: { page: 'dojo', col: 0, row: 3 },
  sex_stamina: { page: 'dojo', col: 1, row: 2 },
  lust_beast:  { page: 'dojo', col: 1, row: 3 },
  dojo_spar:   { page: 'dojo', col: 2, row: 1 },
  m_spar1:     { page: 'dojo', col: 2, row: 2 },
  m_spar2:     { page: 'dojo', col: 2, row: 3 },
  m_cheer1:    { page: 'dojo', col: 3, row: 1 },
  m_cheer2:    { page: 'dojo', col: 3, row: 2 },
  m_cheer3:    { page: 'dojo', col: 3, row: 3 },
  // 摄影房(r0=以摄影室为前置的根;r1=以器材换代为前置的分支+衣装库)
  av_gear:     { page: 'studio', col: 0, row: 0 },
  av_quota:    { page: 'studio', col: 1, row: 0 },
  av_duration: { page: 'studio', col: 2, row: 0 },
  av_play:     { page: 'studio', col: 3, row: 0 },
  m_av_letters:{ page: 'studio', col: 4, row: 0 },
  av_stage:    { page: 'studio', col: 0, row: 1 },
  av_cams:     { page: 'studio', col: 1, row: 1 },
  av_outfits:  { page: 'studio', col: 3, row: 1 },
  ...
  poster2:   { page: 'dailytoy', col: 0, row: 1 },
  poster3:   { page: 'dailytoy', col: 0, row: 2 },
  poster4:   { page: 'dailytoy', col: 0, row: 3 },
  m_diet:    { page: 'dailytoy', col: 1, row: 0 },
  m_toilet:  { page: 'dailytoy', col: 2, row: 0 },
  m_chair:   { page: 'dailytoy', col: 3, row: 0 },
